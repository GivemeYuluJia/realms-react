...
const STYLES = {
  ...
  variant: {
    ...
    primary:
      '  bg-gradient-to-r from-red-600 to-red-900 text-yellow-100 hover:bg-red-700 shadow-lg border-b-2 border-l border-yellow-700 text-yellow-100 active:border-transparent',
    secondary:
